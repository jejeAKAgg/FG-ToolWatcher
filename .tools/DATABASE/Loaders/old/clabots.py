...
class CLABOTSloader:
    ...
    def __init__(self):
        ...
        self.SITEMAPindex = ''
        self.SITEMAPurls: List[str] = ['https://www.clabots.be/media/sitemaps/1/sitemap-product-1.xml.gz']
    ...
    def _discover_sitemaps(self):
        ...
        """
        Dynamically retrieves product sitemap URLs (Sitemapp) from the CLABOTS sitemap index.
        ...
        while self.ATTEMPT < self.MAX_RETRIES:
            try:
                ...
                for loc_tag in soup.find_all('loc'):
                    ...
                    if SEGMENTSdata[1] not in ('www.clabots.be', 'clabots.be'):
                        continue
    ...
    def run(self):
        ...
        CSVpathDBnot = os.path.join(DATA_SUBFOLDER, "CLABOTSproductsDBnot.csv")
        ...
        try:
            ...
            # self._discover_sitemaps()     NO NEED FOR THAT FUNCTION HERE
