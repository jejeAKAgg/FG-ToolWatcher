# .build/debug.spec
# =====================================================
# PyInstaller debug build spec for FG-ToolWatcher
...
exe = EXE(
    ...
    # --- Comportement ---
    console=True,   # NE cache PAS le terminal noir en arrière-plan
...
coll = COLLECT(
    ...
    upx=False,   # NE compresse PAS les binaires (Nécessite UPX installé sur ta machine)
    upx_exclude=[
        'python*.dll',
        'Qt6*.dll',
        'PyQt6/*.pyd',
