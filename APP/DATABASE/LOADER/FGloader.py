...
class FGloader:
    ...
    def __init__(self):
        ...
        # === LOGGER SETUP ===
        self.logger = LogService.logger("FGloader")
    ...
    def run(self):
        ...
        try:
            ...
            self.logger.error(f"Critical error for FGloader: {e}")
        ...
        self.logger.info("FGloader process terminated...")
