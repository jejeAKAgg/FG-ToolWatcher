...
class WebsitesPage(QWidget):
    ...
    """
    QSide6 widget dedicated to the websites management.
    It displays websites and allows their configuration.
    """

    def __init__(self, config: UserService, translator: TranslatorService, parent=None):

        """
        Initializes the WebsitesPage UI components and layout.
        ...
        # --- TITLE ---
        self.title = QLabel(self.translator.get("subpage_settings_websites.title"))
    ...
    def check_validity_and_changes(self):
        ...
        """
        Validates the data of the website management page and enables the save button in case of valid change.
        """
    ...
    def retranslate_ui(self):
        ...
        self.title.setText(self.translator.get("subpage_settings_websites.title"))
