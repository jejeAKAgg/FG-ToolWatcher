...
class TOOLNATIONtuner:
    ...
    def __init__(self, output_file: str, samples_correct: int = 1500, samples_neg: int = 500):
        ...
        self.SOURCES = [
            ...
            {"path": 'USER/DATA/TOOLNATIONproductsDBnot.csv', "count": samples_neg, "label": "NOT"}
        ]
    ...
    def process(self):
        ...
        LOG.info(f"Starting TOOLNATION Curation at {datetime.now().strftime('%H:%M:%S')}")
        ...
        for source in self.SOURCES:
            ...
            for _, row in samples.iterrows():
                ...
                try:
                    ...
                    final_htva = self.parser.format_price_for_excel(round(val_p / 1.20, 2))
                    ...
                    entry = {
                        "instruction": "Extraire EAN, MPN, Marque, Article, Prix HT et Prix TTC en JSON pour TOOLNATION.",
